...
Todas as imagens consideradas relevantes para um entendimento extra da resolução a todas as questões encontram-se listadas na secção de [**Notas/Observações Finais**]().
...
- Imagem **Experiência 1.2** permite observar que é necessário fornecer o número de *bytes* a gerar e o resultado caso esse número seja fornecido.
- Imagem **Experiência 1.3** iguala-se à imagem anterior mas o algoritmo é processado na linguagem Python.
